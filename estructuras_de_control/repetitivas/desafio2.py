...
while continuar.upper() == 'SI':
	...
	cuantas = int(input(f"ingrese la cantidad de colillas recolectadas por la persona {nro_persona}\t"))
	if (cuantas < 100):
		menos_100 += 1
	elif (cuantas < 200):
		mas_100_menos_200 += 1
...
total = menos_100 + mas_100_menos_200 + mas_200

porcentaje_menos_100 = menos_100 * 100 / total
porcentaje_mas_100_menos_200 = mas_100_menos_200 * 100 / total
porcentaje_mas_200 = mas_200 * 100 / total
